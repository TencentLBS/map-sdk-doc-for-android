...
Echo: "Execute commands: git push-f https://github.com/TencentLBS/map-sdk-doc-for-Andoroid.git master:gh-pages"
git push -f https://github.com/TencentLBS/map-sdk-doc-for-Andoroid.git master:gh-pages
